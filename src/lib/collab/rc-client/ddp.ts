...
export type DDPConnectMessage = {
  msg: 'connect';
  version: '1';
  support: string[];
};

export type DDPConnectedMessage = {
  msg: 'connected';
  session: string;
};

export type DDPFailedMessage = {
  msg: 'failed';
  version: string;
};

export type DDPPingMessage = {
  msg: 'ping';
  id?: string;
};

export type DDPPongMessage = {
  msg: 'pong';
  id?: string;
};

export type DDPMethodMessage = {
  msg: 'method';
  method: string;
  params: unknown[];
  id: string;
...
export type DDPUnsubMessage = {
  msg: 'unsub';
  id: string;
};

export type DDPReadyMessage = {
  msg: 'ready';
  subs: string[];
};

export type DDPNosubMessage = {
  msg: 'nosub';
  id: string;
  error?: DDPError;
};

export type DDPAddedMessage = {
  msg: 'added';
  collection: string;
  id: string;
...
export type DDPRemovedMessage = {
  msg: 'removed';
  collection: string;
  id: string;
};

export type DDPError = {
  error: string | number;
  reason?: string;
  message?: string;
  errorType?: string;
